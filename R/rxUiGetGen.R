...
attr(rxUiGet.ipredAtol, "rstudio") <- 0.1
...
attr(rxUiGet.ipredRtol, "rstudio") <- 0.1
...
attr(rxUiGet.predAtol, "rstudio") <- 0.1
...
attr(rxUiGet.predRtol, "rstudio") <- 0.1
...
attr(rxUiGet.sigma, "rstudio") <- structure(c(1, 0, 0, 1), dim = c(2L, 2L))
...
attr(rxUiGet.thetaMat, "rstudio") <- structure(c(1, 0, 0, 1), dim = c(2L, 2L))
...
attr(rxUiGet.dfSub, "rstudio") <- 10L
...
attr(rxUiGet.dfObs, "rstudio") <- 100L
...
attr(rxUiGet.atol, "rstudio") <- 1e-08
...
attr(rxUiGet.rtol, "rstudio") <- 1e-06
...
attr(rxUiGet.ssRtol, "rstudio") <- 1e-06
...
attr(rxUiGet.ssAtol, "rstudio") <- 1e-08
