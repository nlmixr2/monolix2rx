...
- It would make their hard work on the excellent model library harder
  ...
  - Please do not request direct translations of models
    from Monolix to our tool `nlmixr2lib`; these requests will be
    rejected.
...
including models with the model library.  For the regulators to be
able to truly see the models they have to have a working copy
Monolix. If they do not, the model they are using is a black box.  I
believe that many regions this is true.
